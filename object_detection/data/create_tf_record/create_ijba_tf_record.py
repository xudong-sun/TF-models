...
r"""Convert IJBA dataset to TFRecord for object_detection.

Example usage:
    ./create_ijba_tf_record --data_dir=/home/user/IJBA \
        --examples_path=trainval.txt \
        --output_path=/home/user/ijba_trainval.tfrecord
"""
...
def dict_to_tf_example(data,
  ...
  example = tf.train.Example(features=tf.train.Features(feature={
      ...
      'image/format': dataset_util.bytes_feature(image.format),
...
def main(_):
    ...
    logging.info('Reading from IJBA dataset.')
